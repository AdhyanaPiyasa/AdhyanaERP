// student-service/src/main/java/com/adhyana/exam/utils/DatabaseConnection.java
package com.adhyana.exam.utils;
...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/adhyana_exam";
