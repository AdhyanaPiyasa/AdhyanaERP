// administration-service/src/main/java/com/adhyana/administration/utils/DatabaseConnection.java
...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/adhyana_admin";
